...
const String tRoles = "Roles";
const String tFullName = "Full Name";
const String tForgetPassword = "Forget Password";
const String tSignInWithGoogle = "Sign-In with Google";
const String tLogin = "Login";
const String tSignup = "Signup";
const String tCarRegistration = "Car Registration";
...
// -- Welcome Screen Text
const String tWelcomeTitle = "TParking";
...
const String tProfileHeading  = "My Name";
const String tProfileSubHeading  = "My Names";
const String tProfile = "Profile";
const String tEditProfile = "Edit";
const String tDelete = "Delete";
const String tJoinedAt = "Join";
