...
final nowTimes = DateTime.now();
  ...
  Widget build(BuildContext context) {
    ...
    lat1 = event.latitude!;
     ...
     double calculateDistance(double lat1, double lng1, double tnilat, double tnilag) {
    double distance = 0;
   ...
   if (parkingController.isBooked==false) {
    ...
    return Scaffold(
          appBar: AppBar(
            ...
            title: Text('Overview',style: Theme.of(context).textTheme.headlineMedium,),
            centerTitle: true,
                      ...
                      child: ClipRRect(
                        ...
                        child: SizedBox(
                            ...
                            child: FilledButton(onPressed: () {
                                              setState(() {
      distance = calculateDistance(lat1, lng1, tnilat, tnilag);
    });
    if (distance!<=0.15) {
       parkingController.checkoutupdate(parkingController.slotIdPraked);
