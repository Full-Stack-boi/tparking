                      ...
                      child: ElevatedButton(
                        onPressed: () async{
                          ...
                          final UserData = UserModel(
                           ...
                           _image==null? Get.showSnackbar(const GetSnackBar(message: "Your profile didn't change . ",duration: Duration(seconds: 2),)):saveprofile();
                    ...
                    Row(
                      ...
                      confirm: 
                        ElevatedButton(
                          ...
                          onPressed: () {AuthenticationRepository.instance.deleteUser();
                          UserRepository.instance.deleteDocumentByField(user.email);}, child: const Text("YES"),
                        ),
